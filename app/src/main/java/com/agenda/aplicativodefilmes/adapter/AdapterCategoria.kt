...
class AdapterCategoria(private val context: Context, var listaCategoria: MutableList<Categoria> = mutableListOf() ): RecyclerView.Adapter<AdapterCategoria.CategoriaViewHolder>() {
